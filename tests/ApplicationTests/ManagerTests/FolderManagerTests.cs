...
{
	[Fact]
	public async Task method_create_shuld_create_new_folder()
	{
		...
		var folder = $"{folderConfigurator.ActiveFolder}{project.Symbol}_{project.Name}";
	...
	[Fact]
	public async Task method_match_shuld_rename_exist_folder()
	{
		IConfiguration configuration = new ConfigurationBuilder()
		.AddJsonFile("appsettings.json", optional: true)
		.Build();
	...
	[Fact]
	public async Task method_match_shuld_create_new_folder()
	{
		IConfiguration configuration = new ConfigurationBuilder()
		.AddJsonFile("appsettings.json", optional: true)
		.Build();
	...
	[Fact]
	public async Task method_archive_shuld_move_not_empty_folder_to_archive()
	{
		IConfiguration configuration = new ConfigurationBuilder()
		.AddJsonFile("appsettings.json", optional: true)
		.Build();
		...
		var folderSource = $"{folderConfigurator.ActiveFolder}{project.Symbol}_{project.Name}";
		Directory.CreateDirectory($"{folderConfigurator.ActiveFolder}{project.Symbol}_{project.Name}");
		File.WriteAllText($"{folderConfigurator.ActiveFolder}{project.Symbol}_{project.Name}\\Readme.txt", "");
		...
		var folderDest = $"{folderConfigurator.ArchiveFolder}{project.Symbol}_{project.Name}";
	...
	[Fact]
	public async Task method_archive_shuld_return_false_when_folder_is_empty()
	{
		IConfiguration configuration = new ConfigurationBuilder()
		.AddJsonFile("appsettings.json", optional: true)
		.Build();
	...
	[Fact]
	public async Task method_restore_shuld_move_folder_to_actual()
	{
		IConfiguration configuration = new ConfigurationBuilder()
		.AddJsonFile("appsettings.json", optional: true)
		.Build();
		...
		var folderSource = $"{folderConfigurator.ArchiveFolder}{project.Symbol}_{project.Name}";
		var folderDest = $"{folderConfigurator.ActiveFolder}{project.Symbol}_{project.Name}";
